...
It is pretty similar to Markdown, although is more standardized and can do more complex things.
...
For adding a new link in the sidebar you need to add it in https://raw.githubusercontent.com/decidim/documentation/develop/docs/en/modules/ROOT/nav.adoc[nav.adoc file]
